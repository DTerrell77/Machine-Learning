...
#Look up lagrange functions and possible youtube videos 
...
def start():
	...
	print(f'at point 1, lagrange = {lagrange(points[0,0], points):6.2f')
	print(f'at point 2, lagrange = {lagrange(points[0,0], points):6.2f')
	print(f'at point 3, lagrange = {lagrange(points[0,0], points):6.2f')
#end of start()
